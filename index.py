...
def cadastrar_novo_restaurante():
    ...
    ''' Essa função é responsavel por cadastrar un novo restaurante
        Inputs:
    ...
    categoria = input(f'Digite o nome da categoria do restauurante {nome_do_restaurante}:')
...
def alterar_estado_restaurante():
    ...
    for restaurante in restaurantes:
        if nome_restaurante == restaurantes['nome']:
            ...
            sucesso' if restaurante['ativo'] else f'O restaurante {nome_do_restaurante} foi 
